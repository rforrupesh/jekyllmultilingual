---
layout: default
title: แยกไฟล์ PDF ออนไลน์ฟรี - แยก PDF, ตัดไฟล์ PDF ได้ทันที
description: แยกไฟล์ PDF, แยก PDF, แยกหน้า PDF และตัดไฟล์ PDF ออนไลน์ฟรี ไม่ต้องสมัครสมาชิก ไม่ต้องดาวน์โหลด แยก PDF ขนาดใหญ่เป็นไฟล์แยกได้ภายในไม่กี่วินาที
thumbnail: /assets/img/unir.webp
lang: th
ref: splitpdf
permalink: /th/แยกไฟล์-pdf/
head_style: |
    /* ── LAYOUT ── */
    .app-shell {
      display: flex;
...
<div class="app-shell">
  ...
  <a href="/th/terms-of-use/" target="_blank">ข้อกำหนดการใช้งาน</a>
   และ <a href="/th/privacy-policy/" target="_blank">นโยบายความเป็นส่วนตัว</a> ของ เรา
...
<section class="isec-block isec-why" aria-labelledby="isec-why-title">
    <div class="isec-block__head">
      <h2 id="isec-why-title" class="isec-block__title">ทำไมต้องเลือก UnificarPDF.com สำหรับการแยกไฟล์ PDF?</h2>
    </div>
    <div class="isec-card-grid">
      ...
      <div class="isec-card">
        ...
        <h3 class="isec-card__title">แยกหน้าเดียวหรือแยกหลายเอกสาร</h3>
        <p class="isec-card__text">แยกหน้าเดี่ยวออกจากเอกสาร หรือแยกไฟล์ PDF ทั้งหมดออกเป็นหน้าๆ ได้ตามต้องการ</p>
      </div>
      ...
      <div class="isec-card">
        ...
        <h3 class="isec-card__title">แยกหน้าที่ต้องการหรือกำหนดช่วงหน้าเอง</h3>
        <p class="isec-card__text">เลือกหน้าเฉพาะหรือกำหนดช่วงหน้าที่ต้องการแยกได้อย่างอิสระ</p>
      </div>
      ...
      <div class="isec-card">
        ...
        <h3 class="isec-card__title">แยกเป็นเอกสารแต่ละไฟล์</h3>
        <p class="isec-card__text">เอกสารที่แยกจาก PDF เดียวสามารถบันทึกแยกเป็นไฟล์อิสระได้</p>
      </div>
      ...
      <div class="isec-card">
        ...
        <h3 class="isec-card__title">คงองค์ประกอบอินเทอร์แอคทีฟไว้ครบ</h3>
        <p class="isec-card__text">การแยกหน้าจะคงองค์ประกอบอินเทอร์แอคทีฟทั้งหมดไว้ เช่น บุ๊กมาร์ก ไฮเปอร์ลิงก์ และอื่นๆ</p>
      </div>
      ...
      <div class="isec-card">
        ...
        <h3 class="isec-card__title">ดูตัวอย่างหน้าแบบสดก่อนแยก</h3>
        <p class="isec-card__text">ภาพตัวอย่างแสดงเนื้อหาจริงของแต่ละหน้า ไม่ใช่แค่ภาพตัวแทน ตรวจสอบได้ชัดเจนก่อนดาวน์โหลด</p>
      </div>
      ...
      <div class="isec-card">
        ...
        <h3 class="isec-card__title">ลบหน้าที่ไม่ต้องการด้วยคลิกเดียว</h3>
        <p class="isec-card__text">แต่ละภาพตัวอย่างมีปุ่มลบ สามารถลบหน้าที่ไม่ต้องการออกได้โดยไม่ต้องแยกไฟล์ก่อน</p>
      </div>
      ...
      <div class="isec-card">
        ...
        <h3 class="isec-card__title">หมุนหน้าเดียวหรือทุกหน้าพร้อมกัน</h3>
        <p class="isec-card__text">ปรับทิศทางของหน้าเดียวหรือหมุนทุกหน้าพร้อมกันได้ หากหน้าหมุนผิด ปุ่ม Restore จะคืนค่าให้เหมือนเดิม</p>
      </div>
      ...
      <div class="isec-card">
        ...
        <h3 class="isec-card__title">ขนาดไฟล์เล็กลง</h3>
        <p class="isec-card__text">ไฟล์ที่ได้จากการแยก PDF มีขนาดเล็กลงโดยไม่สูญเสียคุณภาพ</p>
      </div>
      ...
      <div class="isec-card">
        ...
        <h3 class="isec-card__title">ประมวลผลได้อย่างต่อเนื่องไม่สะดุด</h3>
        <p class="isec-card__text">ระหว่างประมวลผลไฟล์จะไม่มีการขัดจังหวะใดๆ</p>
      </div>
      ...
      <div class="isec-card">
        ...
        <h3 class="isec-card__title">ไม่มีลายน้ำในไฟล์ผลลัพธ์</h3>
        <p class="isec-card__text">ไฟล์ที่ได้จากการแยก PDF ปราศจากลายน้ำและมีคุณภาพสูง</p>
      </div>
      ...
      <div class="isec-card">
        ...
        <p class="isec-card__text">เครื่องมือแยกไฟล์ PDF ออนไลน์ใช้งานได้บน Windows, Mac, Linux, Android และ iPhone</p>
      </div>
      ...
      <div class="isec-card">
        ...
        <h3 class="isec-card__title">เข้าถึงได้ผ่านเบราว์เซอร์</h3>
        <p class="isec-card__text">ใช้งานผ่านเบราว์เซอร์ได้เลย ไม่ต้องติดตั้งโปรแกรมหรือแอปใดๆ บนอุปกรณ์</p>
      </div>
      ...
      <div class="isec-card">
        ...
        <h3 class="isec-card__title">อัปโหลดไฟล์ PDF ได้ง่าย</h3>
        <p class="isec-card__text">อัปโหลดไฟล์ไปยังเครื่องมือแยก PDF ได้อย่างรวดเร็วและง่ายดาย</p>
      </div>
      ...
      <div class="isec-card">
        ...
        <h3 class="isec-card__title">ไม่ต้องสมัครสมาชิก</h3>
        <p class="isec-card__text">ไม่ต้องสมัครสมาชิกเพื่อแยกไฟล์ PDF ใช้งานได้ฟรีทันที</p>
      </div>
      ...
      <div class="isec-card">
        ...
        <h3 class="isec-card__title">แยกไฟล์ PDF ได้อย่างปลอดภัยและรวดเร็ว</h3>
        <p class="isec-card__text">ประมวลผลไฟล์ PDF ได้โดยไม่มีการสะดุดหรือล่าช้า</p>
      </div>
      ...
      <div class="isec-card">
        ...
        <h3 class="isec-card__title">ดาวน์โหลดได้ทันทีหลังแยกไฟล์</h3>
        <p class="isec-card__text">เมื่อแยกหน้าเสร็จแล้ว ไฟล์พร้อมให้ดาวน์โหลดได้ทันที</p>
      </div>
      ...
      <div class="isec-card">
        ...
        <h3 class="isec-card__title">คงลำดับหน้าเดิม</h3>
        <p class="isec-card__text">สามารถเลือกให้ทุกไฟล์ที่แยกออกมาคงลำดับหน้าเดิมไว้ได้</p>
      </div>
      ...
      <div class="isec-card">
        ...
        <h3 class="isec-card__title">เปลี่ยนไฟล์ได้ตลอดเวลา</h3>
        <p class="isec-card__text">อัปโหลดไฟล์ผิด? กดปุ่ม เปลี่ยน เพื่อสลับไฟล์ใหม่ได้ทันทีโดยไม่ต้องรีเฟรชหน้า</p>
      </div>
  ...
  <section class="isec-block isec-how" aria-labelledby="isec-how-title">
    <div class="isec-block__head">
      <h2 id="isec-how-title" class="isec-block__title">วิธีใช้งานเครื่องมือแยกไฟล์ PDF</h2>
      <p class="isec-block__subtitle">UnificarPDF ทำให้การแยกไฟล์ PDF เป็นเรื่องง่ายมาก ทำตามขั้นตอนเหล่านี้ได้เลย:</p>
    </div>
    <ol class="isec-steps">
      <li>
        <span class="isec-steps__num">1</span>
        <div class="isec-steps__body">อัปโหลดไฟล์ของคุณ ระบบจะแสดงรายละเอียดไฟล์ทันที เพื่อให้ตรวจสอบได้ว่าถูกต้อง หากไม่ใช่ไฟล์ที่ต้องการ ปุ่ม "เปลี่ยน" ที่อยู่ถัดจากรายละเอียดไฟล์จะช่วยให้อัปโหลด PDF ใหม่ได้โดยไม่ต้องโหลดหน้าซ้ำ</div>
      </li>
      <li>
        ...
        <div class="isec-steps__body">
          ...
          <ul class="isec-substeps">
            <li><strong>ช่วงหน้า (Range)</strong> — กำหนดช่วง "ตั้งแต่ถึง" ง่ายๆ ใช้หลายช่วงพร้อมกันได้ (ผลลัพธ์จะรวมอยู่ในไฟล์ ZIP) หรือแบ่งไฟล์ทั้งหมดออกเป็นส่วนเท่าๆ กัน</li>
            <li><strong>เลือกหน้า (Selection)</strong> — คลิกที่ภาพตัวอย่างเพื่อเลือกหน้าที่ต้องการ มีเครื่องมือ เลือกทั้งหมด ล้าง และกลับการเลือก</li>
            <li><strong>ข้ามหน้า (Skip)</strong> — ใส่หมายเลขหน้าที่ต้องการในรูปแบบใดก็ได้ เช่น 4 56-34 1 2-10 รองรับช่วงย้อนกลับด้วย</li>
          </ul>
        </div>
      </li>
      <li>
        <span class="isec-steps__num">3</span>
        <div class="isec-steps__body">ตรวจสอบภาพตัวอย่างทั้งหมด แต่ละหน้าแสดงเป็นภาพตัวอย่างจริงของเนื้อหา ไม่ใช่แค่ภาพตัวแทน มีป้ายกำกับ หน้า 1, หน้า 2 และอื่นๆ ลากและวางภาพตัวอย่างเพื่อจัดเรียงหน้าใหม่ก่อนแยกหรือดาวน์โหลด วางเมาส์บนหน้าใดก็จะมีไอคอนถังขยะสำหรับลบหน้านั้น และไอคอนหมุนสำหรับหมุนหน้านั้นเฉพาะ หรือใช้ หมุนทั้งหมด ที่ด้านบนเพื่อหมุนทุกหน้าพร้อมกัน หากหน้าหมุนผิดทิศ ปุ่ม Restore จะคืนค่าทุกอย่างกลับสู่สภาพเดิม</div>
      </li>
      <li>
        <span class="isec-steps__num">4</span>
        <div class="isec-steps__body">ทางขวาของหัวข้อ "หน้า" มีแถบเลื่อนซูมที่ช่วยปรับขนาดภาพตัวอย่างให้ใหญ่หรือเล็กได้ตามต้องการ โดยแสดงค่าปัจจุบัน เช่น 140 เพื่อให้ดูเนื้อหาได้ชัดเจนขึ้น</div>
      </li>
      <li>
        <span class="isec-steps__num">5</span>
        <div class="isec-steps__body">ดูผลลัพธ์ ดาวน์โหลด PDF (หรือ ZIP หากแยกออกเป็นหลายไฟล์) หรือแชร์ได้ทันที</div>
      </li>
    </ol>
  </section>
  ...
  <section class="isec-block isec-usecases" aria-labelledby="isec-usecases-title">
    <div class="isec-block__head">
      <h2 id="isec-usecases-title" class="isec-block__title">เหมาะกับทุกการใช้งาน</h2>
      <p class="isec-block__subtitle">ดูว่าเครื่องมือแยกไฟล์ PDF ของเราช่วยให้คุณจัดระเบียบและแยกไฟล์ PDF ได้ง่ายขึ้นอย่างไร</p>
    </div>
    <div class="isec-card-grid isec-card-grid--use">
      ...
      <div class="isec-card">
        ...
        <p class="isec-card__text">สร้างไฟล์แยกสำหรับสัญญา รายงาน ใบแจ้งหนี้ และเอกสารนำเสนอ</p>
      </div>
      ...
      <div class="isec-card">
        ...
        <p class="isec-card__text">แยกเนื้อหาที่ต้องการจาก PDF ทางการศึกษา ไม่ว่าจะเป็นบท บทเรียน หรืองานที่มอบหมาย</p>
      </div>
      ...
      <div class="isec-card">
        ...
        <h3 class="isec-card__title">PDF ด้านกฎหมายและการเงิน</h3>
        <p class="isec-card__text">แยกหน้าที่เกี่ยวข้องจากเอกสารกฎหมาย เอกสารธนาคาร และเอกสารราชการต่างๆ</p>
      </div>
      ...
      <div class="isec-card">
        ...
        <h3 class="isec-card__title">แชร์และบันทึกได้ง่ายขึ้น</h3>
        <p class="isec-card__text">เอกสารขนาดเล็กแชร์และจัดเก็บได้สะดวกกว่า</p>
      </div>
  ...
  <section class="isec-block isec-faq" aria-labelledby="isec-faq-title">
    <div class="isec-block__head">
      ...
      <p class="isec-block__subtitle">มีคำถาม? เรามีคำตอบ ค้นหาทุกสิ่งที่ต้องการรู้เกี่ยวกับเครื่องมือแยกไฟล์ PDF ของเรา</p>
    </div>
    ...
    <div class="isec-faq__list">
      <div class="isec-faq__item is-open">
        <button type="button" class="isec-faq__summary" aria-expanded="true">
          <span>เครื่องมือแยกไฟล์ PDF คืออะไร?</span>
        ...
        <div class="isec-faq__panel">
          <div class="isec-faq__panel-inner">
            <p>เครื่องมือแยกไฟล์ PDF คือเว็บแอปพลิเคชันที่ช่วยให้ผู้ใช้แยกไฟล์ PDF ที่มีอยู่ออกเป็น PDF ขนาดเล็กตามหมายเลขหน้าหรือช่วงหน้าที่กำหนด</p>
          </div>
        </div>
      </div>
      <div class="isec-faq__item">
        <button type="button" class="isec-faq__summary" aria-expanded="false">
          <span>แยกไฟล์ PDF ออนไลน์ได้อย่างไร?</span>
          <span class="isec-faq__chev"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg></span>
        </button>
        <div class="isec-faq__panel">
          <div class="isec-faq__panel-inner">
            <p>อัปโหลด PDF → เลือกหน้าหรือช่วงหน้าที่ต้องการ → กด แยกไฟล์ PDF → ดาวน์โหลดไฟล์</p>
          </div>
        </div>
      </div>
      <div class="isec-faq__item">
        <button type="button" class="isec-faq__summary" aria-expanded="false">
          <span>อัปโหลด PDF ด้วยการลากและวางได้ไหม?</span>
          <span class="isec-faq__chev"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg></span>
        </button>
        <div class="isec-faq__panel">
          <div class="isec-faq__panel-inner">
            <p>ได้ เพียงลากและวางไฟล์ PDF ที่ UnificarPDF.com แล้วอัปโหลดได้เลย</p>
          </div>
        </div>
      </div>
      <div class="isec-faq__item">
        <button type="button" class="isec-faq__summary" aria-expanded="false">
          <span>จัดเรียงหรือลบไฟล์ PDF ที่อัปโหลดได้ไหม?</span>
          <span class="isec-faq__chev"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg></span>
        </button>
        <div class="isec-faq__panel">
          <div class="isec-faq__panel-inner">
            <p>ได้ จัดเรียงไฟล์ PDF ที่อัปโหลดใหม่ก่อนแยก หรือลบไฟล์ที่ไม่ต้องการออกได้</p>
          </div>
        </div>
      </div>
      <div class="isec-faq__item">
        <button type="button" class="isec-faq__summary" aria-expanded="false">
          <span>Selection, Range และ Skip ต่างกันอย่างไร?</span>
          <span class="isec-faq__chev"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg></span>
        </button>
        <div class="isec-faq__panel">
          <div class="isec-faq__panel-inner">
            <p>Range เหมาะสำหรับการแยกแบบมีโครงสร้าง เช่น ช่วงเดียว หลายช่วง หรือกลุ่มเท่าๆ กัน Selection คือการคลิกเลือกหน้าจากภาพตัวอย่าง ส่วน Skip เร็วที่สุดหากรู้หมายเลขหน้าที่ต้องการชัดเจนอยู่แล้ว</p>
          </div>
        </div>
      </div>
      <div class="isec-faq__item">
        <button type="button" class="isec-faq__summary" aria-expanded="false">
          <span>แยก PDF ตามหมายเลขหน้าหรือช่วงหน้าได้ไหม?</span>
          <span class="isec-faq__chev"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg></span>
        </button>
        <div class="isec-faq__panel">
          <div class="isec-faq__panel-inner">
            <p>ได้ เลือกหน้าหรือช่วงหน้าที่ต้องการแยกออกจาก PDF ได้เลย</p>
          </div>
        </div>
      </div>
      <div class="isec-faq__item">
        <button type="button" class="isec-faq__summary" aria-expanded="false">
          <span>แยกเฉพาะหน้าที่เลือกออกจาก PDF ได้ไหม?</span>
          <span class="isec-faq__chev"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg></span>
        </button>
        <div class="isec-faq__panel">
          <div class="isec-faq__panel-inner">
            <p>ได้ แยกและบันทึกหน้าเดียว หลายหน้า หรือช่วงหน้าที่กำหนดเป็น PDF ใหม่ได้</p>
          </div>
        </div>
      </div>
      <div class="isec-faq__item">
        <button type="button" class="isec-faq__summary" aria-expanded="false">
          <span>เมื่อแยกไฟล์ PDF แล้วจะได้ไฟล์อะไร?</span>
          <span class="isec-faq__chev"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg></span>
        </button>
        <div class="isec-faq__panel">
          <div class="isec-faq__panel-inner">
            <p>หากผลลัพธ์เป็น PDF เดียวจะดาวน์โหลดเป็นไฟล์ PDF หากแยกออกเป็นหลายไฟล์จะบีบอัดเป็นไฟล์ ZIP</p>
          </div>
        </div>
      </div>
      <div class="isec-faq__item">
        <button type="button" class="isec-faq__summary" aria-expanded="false">
          <span>การแยกไฟล์จะทำให้คุณภาพ PDF ลดลงไหม?</span>
          <span class="isec-faq__chev"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg></span>
        </button>
        <div class="isec-faq__panel">
          <div class="isec-faq__panel-inner">
            <p>ไม่ รูปแบบ ฟอนต์ เค้าโครง รูปภาพ ข้อความ และทุกอย่างยังคงสมบูรณ์</p>
          </div>
        </div>
      </div>
      <div class="isec-faq__item">
        <button type="button" class="isec-faq__summary" aria-expanded="false">
          <span>แยกไฟล์ PDF ขนาดใหญ่ได้ไหม?</span>
          <span class="isec-faq__chev"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg></span>
        </button>
        <div class="isec-faq__panel">
          <div class="isec-faq__panel-inner">
            <p>ได้ รองรับไฟล์ PDF ทุกขนาด ทั้งเล็กและใหญ่</p>
          </div>
        </div>
      </div>
      <div class="isec-faq__item">
        <button type="button" class="isec-faq__summary" aria-expanded="false">
          <span>แยกไฟล์ PDF ที่มีรหัสผ่านได้ไหม?</span>
          <span class="isec-faq__chev"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg></span>
        </button>
        <div class="isec-faq__panel">
          <div class="isec-faq__panel-inner">
            <p>ได้ ใส่รหัสผ่านเพื่อปลดล็อกแล้วแยกไฟล์ได้เลย</p>
          </div>
        </div>
      </div>
      <div class="isec-faq__item">
        <button type="button" class="isec-faq__summary" aria-expanded="false">
          <span>ต้องดาวน์โหลดหรือติดตั้งโปรแกรมไหม?</span>
          <span class="isec-faq__chev"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg></span>
        </button>
        <div class="isec-faq__panel">
          <div class="isec-faq__panel-inner">
            <p>ไม่ต้อง ทุกอย่างทำงานผ่านเบราว์เซอร์ ไม่ต้องทำอะไรเพิ่มเติม</p>
          </div>
        </div>
      </div>
      <div class="isec-faq__item">
        <button type="button" class="isec-faq__summary" aria-expanded="false">
          <span>ต้องสร้างบัญชีก่อนไหม?</span>
          <span class="isec-faq__chev"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg></span>
        </button>
        <div class="isec-faq__panel">
          <div class="isec-faq__panel-inner">
            <p>ไม่ต้อง UnificarPDF.com ใช้งานได้โดยไม่ต้องลงทะเบียนหรือเข้าสู่ระบบ</p>
          </div>
        </div>
      </div>
      <div class="isec-faq__item">
        <button type="button" class="isec-faq__summary" aria-expanded="false">
          <span>ใช้งานบนมือถือได้ไหม?</span>
          <span class="isec-faq__chev"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg></span>
        </button>
        <div class="isec-faq__panel">
          <div class="isec-faq__panel-inner">
            <p>ได้ แยกไฟล์ PDF บน Android, iPhone, แท็บเล็ต, แล็ปท็อป และ PC ได้เลย</p>
          </div>
        </div>
      </div>
      <div class="isec-faq__item">
        <button type="button" class="isec-faq__summary" aria-expanded="false">
          <span>ไฟล์ PDF ของฉันปลอดภัยไหม?</span>
          <span class="isec-faq__chev"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg></span>
        </button>
        <div class="isec-faq__panel">
          <div class="isec-faq__panel-inner">
            <p>ปลอดภัย ไฟล์ถูกถ่ายโอนอย่างปลอดภัย และเมื่อแยกไฟล์เสร็จแล้ว ระบบจะลบไฟล์ที่อัปโหลดและไฟล์ที่สร้างออกจากเซิร์ฟเวอร์โดยอัตโนมัติ</p>
          </div>
        </div>
      </div>
      <div class="isec-faq__item">
        <button type="button" class="isec-faq__summary" aria-expanded="false">
          <span>UnificarPDF.com ใช้งานฟรีไหม?</span>
          <span class="isec-faq__chev"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg></span>
        </button>
        <div class="isec-faq__panel">
          <div class="isec-faq__panel-inner">
            <p>ฟรี แยกไฟล์ PDF ออนไลน์ได้ฟรีโดยไม่ต้องดาวน์โหลดโปรแกรมหรือสมัครสมาชิก</p>
          </div>
        </div>
      </div>
    </div>
