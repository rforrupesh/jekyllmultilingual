---
layout: default
title: PDF-Seiten nach Bereichen teilen – PDF online aufteilen
description: Teilen Sie große PDF-Dateien in Sekundenschnelle in einzelne PDFs auf. Kombinieren Sie mehrere Dateien, ordnen Sie Seiten neu und entfernen Sie Seiten mit unserem kostenlosen Online-Tool. Keine Registrierung, kein Download erforderlich.
thumbnail: /assets/img/unir.webp
lang: de
ref: splitpdf
permalink: /de/pdf-teilen/
head_style: |
    /* ── LAYOUT ── */
    .app-shell {
      display: flex;
