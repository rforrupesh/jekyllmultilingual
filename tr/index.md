---
layout: default
title: PDF Dosyalarını Online Birleştir – PDF Dosyalarını Birleştirmek İçin Ücretsiz Hizmet
description: "PDF dosyalarınızı kolayca yükleyin ve düzenleyin, ardından tek bir birleştirilmiş belge olarak indirin. Hızlı, sınırsız ve tamamen ücretsiz çevrim içi PDF Birleştirme aracı."
keywords: "PDF Birleştir, PDF Böl, PDF dosyalarını online birleştir, PDF dosyalarını birleştirmek, PDF Ayır, PDF Sıkıştır, PDF Dönüştür, Word'den PDF'ye, Excel'den PDF'ye, PowerPoint'ten PDF'ye, PDF'den JPG'ye, JPG'den PDF'ye"
ref: home
lang: tr
permalink: /tr/
head_style: |
...
<main class="container1">
  ...
  <h1 class="page-title" id="pageTitle">PDF Dosyalarını Online Birleştir (Merge PDF)</h1>
  <p class="page-sub" id="pageSub">PDF dosyalarınızı yükleyin, sıralayın, PDF'leri Birleştir'e tıklayın ve yeni birleştirilmiş PDF dosyanızı indirin.</p>
  ...
  <div id="uploadState">
    <div class="upload-box" id="dropZone">
      ...
      <h2>PDF dosyalarını buraya sürükleyin</h2>
      <p>veya göz atmak için aşağıdaki düğmeye tıklayın.</p>
  ...
  <div id="uploadedState">
    <div class="toolbar">
      <div class="toolbar-left">
        <span class="toolbar-title">Birleştirilecek Dosyalar</span>
    ...
    <div class="progress-wrap" id="progressWrap">
      ...
      <span class="progress-text" id="progressText">Birleştiriliyor…</span>
    </div>
  </div>
