---
layout: default
title: PDF sayfalarını aralıklara göre böl - Online PDF ayırma
description: "Büyük dosyalarınızı saniyeler içinde ayrı dosyalara bölün. Ücretsiz online aracımızla PDF bölme ve PDF ayırma işlemlerini kolayca yapın, bölümleri yeniden düzenleyin ve sayfaları silin. Kayıt yok, indirme yok."
keywords: "pdf ayırma, pdf bölme, pdf ayır, pdf ayirma, pdf böl"
thumbnail: /assets/img/unir.webp
lang: tr
ref: splitpdf
permalink: /tr/pdf-bolme/
head_style: |
    /* ── LAYOUT ── */
    .app-shell {
      display: flex;
...
<div class="app-shell">
  ...
  <div id="uploadState">
    <div class="upload-inner">
      <h1>PDF Bölme</h1>
      <p class="sub">Tek tek sayfaları veya tam belge setlerini bağımsız PDF dosyalarına ayırın.</p>
      <div class="drop-zone" id="dropZone">
        ...
        <h2>PDF dosyasını buraya bırakın</h2>
        <p>veya göz atmak için aşağıdaki butona tıklayın</p>
        ...
        <p class="upload-note">
            ...
            Dosya yükleyerek 
  <a href="/tr/terms-of-use/" target="_blank">Kullanım Şartları</a>mızı
  ve
  <a href="/tr/privacy-policy/" target="_blank">Gizlilik Politikası</a>mızı kabul etmiş olursunuz.
...
<section class="isec-block isec-why" aria-labelledby="isec-why-title">
    <div class="isec-block__head">
      <h2 id="isec-why-title" class="isec-block__title">PDF Sayfaları Kaldırmak İçin Neden UnificarPDF.com'u Seçmelisiniz?</h2>
    </div>
    <div class="isec-card-grid">
      ...
      <div class="isec-card">
        ...
        <h3 class="isec-card__title">Tek Sayfa Bölme / Çoklu Belge Bölme</h3>
        <p class="isec-card__text">Bir belgeden tek bir sayfayı ayırın veya belgeyi sayfalara bölün.</p>
      </div>
      ...
      <div class="isec-card">
        ...
        <h3 class="isec-card__title">Belirli/Özelleştirilmiş Sayfaları Bölme</h3>
        <p class="isec-card__text">Burada bölmek için belirli veya özelleştirilmiş sayfa aralıkları seçme seçeneğiniz var.</p>
      </div>
      ...
      <div class="isec-card">
        ...
        <h3 class="isec-card__title">Ayrı Belgelere Bölme</h3>
        <p class="isec-card__text">Tek bir PDF'den bölünen belgeler ayrı ayrı kaydedilebilir.</p>
      </div>
      ...
      <div class="isec-card">
        ...
        <h3 class="isec-card__title">Etkileşimli Öğeler Korunur</h3>
        <p class="isec-card__text">Sayfa bölme işlemi, yer imi, köprü gibi tüm etkileşimli öğeleri korur.</p>
      </div>
      ...
      <div class="isec-card">
        ...
        <h3 class="isec-card__title">Canlı Sayfa Önizlemeleri</h3>
        <p class="isec-card__text">Küçük resimler genel yer tutucular yerine gerçek sayfa içeriğinizi gösterir; böylece indirmeden önce tam olarak neyi böldüğünüzü doğrulayabilirsiniz.</p>
      </div>
      ...
      <div class="isec-card">
        ...
        <h3 class="isec-card__title">İstenmeyen Sayfaları Tek Tıkla Kaldırın</h3>
        <p class="isec-card__text">Her küçük resimde bir silme düğmesi bulunur; bu sayede ihtiyaç duymadığınız bir sayfayı bölme işlemi yapmadan bile silebilirsiniz.</p>
      </div>
      ...
      <div class="isec-card">
        ...
        <h3 class="isec-card__title">Tek Tek Sayfaları veya Tüm Sayfaları Aynı Anda Döndürün</h3>
        <p class="isec-card__text">Tek bir sayfanın yönünü düzeltebilir veya tüm sayfaları aynı anda döndürebilirsiniz. Sayfanız yanlış yöndeyse, Geri Yükle özelliği her şeyi eski haline getirir.</p>
      </div>
      ...
      <div class="isec-card">
        ...
        <h3 class="isec-card__title">Daha Küçük Dosya Boyutu</h3>
        <p class="isec-card__text">PDF dosyalarını böldükten sonra oluşturulan dosyalar, kaliteden ödün vermeden küçük boyutlarda olur.</p>
      </div>
      ...
      <div class="isec-card">
        ...
        <h3 class="isec-card__title">İşlem Sırasında Kesinti Olmaz</h3>
        <p class="isec-card__text">Dosyalar işlenirken, işlem sırasında herhangi bir kesintiye uğramaz.</p>
      </div>
      ...
      <div class="isec-card">
        ...
        <h3 class="isec-card__title">Filigransız Dosyalar</h3>
        <p class="isec-card__text">PDF'yi böldükten sonra oluşturulan dosyalar filigranlardan arındırılmıştır ve dosyalar yüksek kalitededir.</p>
      </div>
      ...
      <div class="isec-card">
        ...
        <h3 class="isec-card__title">Birden Fazla İşletim Sisteminde Kullanılabilir</h3>
        <p class="isec-card__text">Çevrimiçi PDF bölme aracı, Windows, Mac, Linux, Android ve iPhone gibi farklı işletim sistemlerinde kullanılabilir.</p>
      </div>
      ...
      <div class="isec-card">
        ...
        <h3 class="isec-card__title">Tarayıcı Üzerinden Erişilebilir</h3>
        <p class="isec-card__text">Tarayıcı üzerinden erişilebilir olduğu için cihazınıza yazılım veya uygulama yüklemenize gerek yoktur.</p>
      </div>
      ...
      <div class="isec-card">
        ...
        <h3 class="isec-card__title">PDF Dosyalarını Kolayca Yükleyebilirsiniz</h3>
        <p class="isec-card__text">Dosyanızı bölme aracına kolayca yükleyebilirsiniz.</p>
      </div>
      ...
      <div class="isec-card">
        ...
        <h3 class="isec-card__title">Kayıt Gerektirmez</h3>
        <p class="isec-card__text">PDF dosyanızı işlemek için web sitesine kayıt olmanıza gerek yoktur. Tamamen ücretsizdir.</p>
      </div>
      ...
      <div class="isec-card">
        ...
        <h3 class="isec-card__title">PDF'leri Herhangi Bir Gecikme Olmadan Güvenli Şekilde İşleyin</h3>
        <p class="isec-card__text">PDF dosyaları herhangi bir kesinti veya gecikme olmadan işlenebilir.</p>
      </div>
      ...
      <div class="isec-card">
        ...
        <h3 class="isec-card__title">İndirilebilir Dosyalar Hemen Kullanıma Sunulur</h3>
        <p class="isec-card__text">Sayfa bölme işlemi tamamlandığında, indirilebilir dosyalar anında indirmeye hazır hale gelir.</p>
      </div>
      ...
      <div class="isec-card">
        ...
        <h3 class="isec-card__title">Aynı Sayfa Sırası</h3>
        <p class="isec-card__text">Tüm dosyalarda aynı sayfa sırası seçilebilir.</p>
      </div>
      ...
      <div class="isec-card">
        ...
        <h3 class="isec-card__title">Dosyaları istediğiniz zaman değiştirin</h3>
        <p class="isec-card__text">Yanlış PDF mi yüklediniz? Sayfayı yenilemeden anında değiştirmek için Değiştir düğmesini kullanın.</p>
      </div>
  ...
  <section class="isec-block isec-how" aria-labelledby="isec-how-title">
    <div class="isec-block__head">
      <h2 id="isec-how-title" class="isec-block__title">PDF Bölücümüz Nasıl Çalışır</h2>
      <p class="isec-block__subtitle">UnifcarPDF programı, bir PDF dosyasını bölmeyi çok kolaylaştırır. İşte nasıl yapılacağı:</p>
    </div>
    <ol class="isec-steps">
      <li>
        <span class="isec-steps__num">1</span>
        <div class="isec-steps__body">Dosyanızı yükleyin. Dosya ayrıntıları hemen görüntülenir, böylece doğru dosyanın orada olduğundan emin olabilirsiniz — değilse, dosya ayrıntılarının hemen yanında bulunan "Değiştir" düğmesi, sayfayı yeniden yüklemeden başka bir PDF yüklemenizi sağlar.</div>
      </li>
      <li>
        <span class="isec-steps__num">2</span>
        <div class="isec-steps__body">
          Bir bölme modu seçin:
          <ul class="isec-substeps">
            <li><strong>Aralık</strong> — basit bir "Şuradan Şuraya" aralığı seçin, birden fazla aralığı aynı anda kullanın (hepsi bir ZIP içinde döndürülür) veya tüm dosyayı eşit parçalara bölün.</li>
            <li><strong>Seçim</strong> — tam olarak ihtiyacınız olanı seçmek için sayfa küçük resimlerine tıklayın; Tümünü Seç, Temizle ve Tersine Çevir araçları da kullanışlıdır.</li>
            <li><strong>Atla</strong> — istediğiniz sayfaları herhangi bir formatta girin, örneğin 4 56-34 1 2-10. Ters aralıklar da desteklenir.</li>
          </ul>
        </div>
      </li>
      <li>
        <span class="isec-steps__num">3</span>
        <div class="isec-steps__body">Tüm ızgarayı kontrol edin. Her sayfa, kendisinin canlı bir küçük resim önizlemesi olarak görüntülenir — sadece bir yer tutucu değil, gerçek sayfa içeriği — Sayfa 1, Sayfa 2 vb. olarak etiketlenir. Bölme veya indirme işleminden önce sayfaları yeniden düzenlemek için herhangi bir küçük resmi sürükleyip bırakabilirsiniz. Herhangi bir sayfanın üzerine gelin, o sayfayı silmek için küçük bir çöp kutusu simgesi ve o sayfayı ayrı ayrı döndürmek için bir döndürme simgesi göreceksiniz — veya tüm sayfaları aynı anda döndürmek için üstteki Tümünü Döndür seçeneğini kullanın. Bir sayfa (veya tüm set) yanlış yönde dönmüş olursa, Geri Yükle düğmesi her şeyi eski haline getirir.</div>
      </li>
      <li>
        <span class="isec-steps__num">4</span>
        <div class="isec-steps__body">"Sayfalar" başlığının sağında, içeriğe ne kadar yakından bakmanız gerektiğine bağlı olarak küçük resim boyutunu artırmanızı veya azaltmanızı sağlayan bir yakınlaştırma kaydırıcısı bulunur (140 gibi mevcut değeri de gösterir).</div>
      </li>
      <li>
        <span class="isec-steps__num">5</span>
        <div class="isec-steps__body">Sonucunuzu görüntüleyin. PDF'yi (veya birden fazla dosyaya böldüyseniz ZIP'i) indirin ya da hemen paylaşın.</div>
      </li>
    </ol>
  </section>
  ...
  <section class="isec-block isec-usecases" aria-labelledby="isec-usecases-title">
    <div class="isec-block__head">
      <h2 id="isec-usecases-title" class="isec-block__title">Her Kullanım Senaryosu İçin Mükemmel</h2>
      <p class="isec-block__subtitle">PDF bölücümüzün PDF belgelerinizi kolayca düzenlemenize ve bölmenize nasıl yardımcı olduğunu görün.</p>
    </div>
    <div class="isec-card-grid isec-card-grid--use">
      ...
      <div class="isec-card">
        ...
        <p class="isec-card__text">Sözleşmeler, raporlar, faturalar ve sunumlar için ayrı dosyalar oluşturun.</p>
      </div>
      ...
      <div class="isec-card">
        ...
        <p class="isec-card__text">Akademik PDF'lerinizden bölüm, ders veya ödev gibi belirli içerikleri çıkarın.</p>
      </div>
      ...
      <div class="isec-card">
        ...
        <h3 class="isec-card__title">Hukuki ve Mali PDF'ler</h3>
        <p class="isec-card__text">Hukuki belgelerden, banka belgelerinden ve diğer resmi belgelerden ilgili sayfaları çıkarın.</p>
      </div>
      ...
      <div class="isec-card">
        ...
        <h3 class="isec-card__title">Paylaşımı ve Kaydetmesi Daha Kolay</h3>
        <p class="isec-card__text">Küçük belgelerin paylaşılması ve saklanması kolaydır.</p>
      </div>
  ...
  <section class="isec-block isec-faq" aria-labelledby="isec-faq-title">
    <div class="isec-block__head">
      ...
      <p class="isec-block__subtitle">Sorularınız mı var? Cevaplarımız var. PDF Bölücümüz hakkında bilmeniz gereken her şeyi burada bulun.</p>
    </div>
      ...
      <div class="isec-faq__item is-open">
        ...
        <div class="isec-faq__panel">
          <div class="isec-faq__panel-inner">
            <p>PDF Bölücü, kullanıcıların mevcut PDF belgelerini belirli sayfa numaraları veya aralıklarına göre daha küçük PDF'lere bölebildiği bir web uygulamasıdır.</p>
          </div>
        </div>
      </div>
      <div class="isec-faq__item">
        <button type="button" class="isec-faq__summary" aria-expanded="false">
          <span>PDF Çevrimiçi Nasıl Bölünür?</span>
          <span class="isec-faq__chev"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg></span>
        </button>
        <div class="isec-faq__panel">
          <div class="isec-faq__panel-inner">
            <p>PDF(leri) yükleyin, istediğiniz sayfaları (veya sayfa aralıklarını) seçin, PDF Böl'e tıklayın, dosyanızı indirin.</p>
          </div>
        </div>
      </div>
      <div class="isec-faq__item">
        <button type="button" class="isec-faq__summary" aria-expanded="false">
          <span>PDF'imi Sürükle &amp; Bırak ile yükleyebilir miyim?</span>
          <span class="isec-faq__chev"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg></span>
        </button>
        <div class="isec-faq__panel">
          <div class="isec-faq__panel-inner">
            <p>Evet. PDF belgelerinizi UnificarPDF.com'a sürükleyip bırakarak yükleyebilirsiniz.</p>
          </div>
        </div>
      </div>
      <div class="isec-faq__item">
        <button type="button" class="isec-faq__summary" aria-expanded="false">
          <span>Yüklenen PDF belgelerini yeniden sıralamak veya silmek mümkün mü?</span>
          <span class="isec-faq__chev"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg></span>
        </button>
        <div class="isec-faq__panel">
          <div class="isec-faq__panel-inner">
            <p>Evet. Dönüştürmeden önce yüklenen PDF dosyalarını yeniden sıralayabilir veya ihtiyacınız olmayan dosyaları silebilirsiniz.</p>
          </div>
        </div>
      </div>
      <div class="isec-faq__item">
        <button type="button" class="isec-faq__summary" aria-expanded="false">
          <span>Seçim, Aralık ve Atla — Aralarındaki fark nedir?</span>
          <span class="isec-faq__chev"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg></span>
        </button>
        <div class="isec-faq__panel">
          <div class="isec-faq__panel-inner">
            <p>Aralık; tek aralık, çoklu aralık veya eşit gruplar gibi yapılandırılmış bölmeler içindir. Seçim, küçük resimler üzerinde görsel olarak tıklamaktır. Atla ise hangi sayfa numaralarını istediğinizi zaten biliyorsanız en hızlı yöntemdir.</p>
          </div>
        </div>
      </div>
      <div class="isec-faq__item">
        <button type="button" class="isec-faq__summary" aria-expanded="false">
          <span>PDF'imi sayfa numaralarına/sayfa aralıklarına göre bölebilir miyim?</span>
          <span class="isec-faq__chev"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg></span>
        </button>
        <div class="isec-faq__panel">
          <div class="isec-faq__panel-inner">
            <p>Evet. PDF'den bölmek istediğiniz sayfaları veya sayfa aralığını seçin.</p>
          </div>
        </div>
      </div>
      <div class="isec-faq__item">
        <button type="button" class="isec-faq__summary" aria-expanded="false">
          <span>PDF'den seçilen sayfaları çıkarmak mümkün mü?</span>
          <span class="isec-faq__chev"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg></span>
        </button>
        <div class="isec-faq__panel">
          <div class="isec-faq__panel-inner">
            <p>Evet. Tek bir sayfayı, birden fazla sayfayı veya belirli bir sayfa aralığını çıkarıp yeni bir PDF olarak kaydedebilirsiniz.</p>
          </div>
        </div>
      </div>
      <div class="isec-faq__item">
        <button type="button" class="isec-faq__summary" aria-expanded="false">
          <span>PDF'imi böldüğümde ne olur?</span>
          <span class="isec-faq__chev"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg></span>
        </button>
        <div class="isec-faq__panel">
          <div class="isec-faq__panel-inner">
            <p>PDF'inizi böldüğünüzde sonuç tek bir PDF ise, PDF olarak indirilir. Birden fazla PDF'ye bölünürse, ZIP arşivi olarak paketlenir.</p>
          </div>
        </div>
      </div>
      <div class="isec-faq__item">
        <button type="button" class="isec-faq__summary" aria-expanded="false">
          <span>Bölme işlemi PDF dosyamın kalitesini etkiler mi?</span>
          <span class="isec-faq__chev"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg></span>
        </button>
        <div class="isec-faq__panel">
          <div class="isec-faq__panel-inner">
            <p>Hayır. Biçimlendirme, yazı tipi, düzen, resimler, metin ve diğer her şey olduğu gibi kalır.</p>
          </div>
        </div>
      </div>
      <div class="isec-faq__item">
        <button type="button" class="isec-faq__summary" aria-expanded="false">
          <span>Büyük PDF'leri bölebilir misiniz?</span>
          <span class="isec-faq__chev"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg></span>
        </button>
        <div class="isec-faq__panel">
          <div class="isec-faq__panel-inner">
            <p>Evet. Büyük ya da küçük, her boyuttaki PDF ile çalışır.</p>
          </div>
        </div>
      </div>
      <div class="isec-faq__item">
        <button type="button" class="isec-faq__summary" aria-expanded="false">
          <span>Şifre korumalı PDF'leri bölmek mümkün mü?</span>
          <span class="isec-faq__chev"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg></span>
        </button>
        <div class="isec-faq__panel">
          <div class="isec-faq__panel-inner">
            <p>Elbette. Şifreyi çözün ve bölme işlemini gerçekleştirin.</p>
          </div>
        </div>
      </div>
      <div class="isec-faq__item">
        <button type="button" class="isec-faq__summary" aria-expanded="false">
          <span>Herhangi bir yazılım indirmem veya yüklemem gerekiyor mu?</span>
          <span class="isec-faq__chev"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg></span>
        </button>
        <div class="isec-faq__panel">
          <div class="isec-faq__panel-inner">
            <p>Hayır. Her şey web tarayıcınızda çalışır. Başka bir şey yapmanıza gerek yok.</p>
          </div>
        </div>
      </div>
      <div class="isec-faq__item">
        ...
        <div class="isec-faq__panel">
          <div class="isec-faq__panel-inner">
            <p>Hayır, UnificarPDF.com kayıt olmadan, giriş yapmadan kullanılabilir.</p>
          </div>
        </div>
      </div>
      <div class="isec-faq__item">
        <button type="button" class="isec-faq__summary" aria-expanded="false">
          <span>Araç mobil cihazlarla uyumlu mu?</span>
          <span class="isec-faq__chev"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg></span>
        </button>
        <div class="isec-faq__panel">
          <div class="isec-faq__panel-inner">
            <p>Evet. Android, iPhone, tablet, dizüstü ve masaüstü bilgisayarlarda PDF'leri bölebilirsiniz.</p>
          </div>
        </div>
      </div>
      <div class="isec-faq__item">
        <button type="button" class="isec-faq__summary" aria-expanded="false">
          <span>PDF dosyam güvende mi?</span>
          <span class="isec-faq__chev"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg></span>
        </button>
        <div class="isec-faq__panel">
          <div class="isec-faq__panel-inner">
            <p>Evet. Dosyalar güvenli bir şekilde aktarılır. PDF bölme işlemini tamamladıktan sonra, yüklenen ve oluşturulan dosyalar sunucudan otomatik olarak kaldırılır.</p>
          </div>
        </div>
      </div>
      <div class="isec-faq__item">
        <button type="button" class="isec-faq__summary" aria-expanded="false">
          <span>UnificarPDF.com kullanımı ücretsiz mi?</span>
          <span class="isec-faq__chev"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg></span>
        </button>
        <div class="isec-faq__panel">
          <div class="isec-faq__panel-inner">
            <p>Evet. PDF dosyalarını yazılım indirmeden ve kayıt olmadan ücretsiz olarak çevrimiçi bölebilirsiniz.</p>
          </div>
        </div>
      </div>
    </div>
